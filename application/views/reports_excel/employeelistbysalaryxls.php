...
//KENNEDY 
    ...
    $xls->send("Employee List By Salary.xls");
    ...
    $result = $this->reports->allEmpBySalary($isactive);   
    ...
    array_push($fields, array("SALARY",1,35,1));
    ...
    foreach ($cdata as $emp) {
        ...
        $c++;
         $sheet->write($r,$c,($emp->monthly > 0 ? "PHP ".number_format($emp->monthly, 2) : 'No Data'),$normalcenter);
        $c++;
        $r++;
        $c=0;
    ...
    $c++;
     $sheet->write($r,$c,"",$normalcenter);
    $c++;
    $sheet->write($r,$c,"Total:",$normalright);
    $c++;
     $sheet->write($r,$c,$empcount,$normalcenter);
    $c++;
    $r++;

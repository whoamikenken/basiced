 ...
 */
    ...
    $xls->send("Employee Confirmed.xls");
    ...
    $c = 0;$r = 0;
    $sheet->write($r,$c,"Employee Confirmed",$bigboldcenter);
    ...
    foreach($data->result() as $row){
        ...
        $sheet->write($r,$c,date('F d, Y',strtotime($row->CutOffFrom)),$normalcenter);$c++;
        $sheet->write($r,$c,date('F d, Y',strtotime($row->CutOffTo)),$normalcenter);$c++;
        $sheet->write($r,$c,date('F d, Y',strtotime($row->Confirmed)),$normalcenter);$c++;
        $r++;
    }

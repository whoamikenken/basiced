...
//KENNEDY 
    ...
    $result = $this->reports->allEmpByPosition($isactive);   
    ...
    array_push($fields, array("EMPLOYEE NAME",1,85,1));
        ...
        if($position != $emp->positionid)
        {
            ...
            for ($i=0; $i < 3; $i++) { 
                if($i == 0){
                    ...
                    $sheet->write($r,$i,iconv("UTF-8", "ISO-8859-1//IGNORE", $this->extensions->getPositionDescription($emp->positionid)),$colOffice);
                }else{

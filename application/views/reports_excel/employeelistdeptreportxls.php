...
//KENNEDY 
    ...
    $xls->send("Employee List By Department.xls");
    ...
    $timeform->setLocked();
    /* END */
    isset($isactive) ? $isactive : '';
    $result = $this->reports->allEmpByDept($isactive);   
        ...
        if($dept != $emp->description)
        {
            ...
            for ($i=0; $i < 3; $i++) { 
                if($i == 0){
                    ...
                    $sheet->write($r,$i,iconv("UTF-8", "ISO-8859-1//IGNORE",$description),$colOffice);
                }else{

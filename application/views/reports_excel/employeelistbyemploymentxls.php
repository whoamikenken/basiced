...
//KENNEDY 
    ...
    $xls->send("Employee List By Employment Status.xls");
    ...
    $result = $this->reports->allEmpByEmpStat($isactive);   
        ...
        if($empStatus != $emp->employmentstat)
        {
            ...
            for ($i=0; $i < 3; $i++) { 
                if($i == 0){
                    ...
                    $sheet->write($r,$i,($emp->employmentstat? $emp->employmentstat: ''),$colOffice);
                }else{

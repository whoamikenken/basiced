...
//KENNEDY 
    ...
    $xls->send("Employee List By Gender.xls");
    ...
    $result = $this->reports->allEmpByGender($isactive);   
    ...
    foreach ($cdata as $emp) {
        if($gender != $emp->gender)
        {
            ...
            $gender = $emp->gender;
            if($emp->gender == "F") $display = "FEMALE";
            else if($emp->gender == "M") $display = "MALE";
            else $display = "NO GENDER";

            $sheet->write($r,$c,$display,$colOffice);

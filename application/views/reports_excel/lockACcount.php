...
//KENNEDY 
    ...
    $xls->send("Lock Account History Report.xls");
    ...
    $data = $this->reports->getLockUnlockData($deptid, $dateFrom, $dateTo, 'lock'); 
    ...
    $r++;
    $sheet->write(3,3,"Lock Account History Report",$bigboldcenter);
    $r++;

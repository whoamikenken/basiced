...
//KENNEDY 
    ...
    $result = $this->reports->allEmpAttendanceAbsent($date,$sort);
    ...
    array_push($fields, array("EMPLOYEE NAME",1,65,1));
    ...
    $r++;
    $sheet->write(3,0,"Absent Employee On ".$date,$normalcenter);
    ...
    foreach ($cdata as $emp) {
        if ($this->reports->LeaveOBChecker($emp->oldemployee,$date)){}else{
               if($sort == "office"){

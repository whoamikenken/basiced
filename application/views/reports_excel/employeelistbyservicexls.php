...
//KENNEDY 
    ...
    $xls->send("Employee List By Year Of Service.xls");
    ...
    $result = $this->reports->allEmpYearService($isactive); 
    ...
    array_push($fields, array("YEARS OF SERVICE",1,35,1));
    ...
    foreach ($cdata as $emp) {
        ...
        $c++;
         $sheet->write($r,$c,(($emp->dateemployed != null && $emp->dateemployed != "0000-00-00")? $this->extensions->GetYearDiffBasedOnToday($emp->dateemployed) : 'No Data'),$normalcenter);
        $c++;
        $r++;
        $c=0;
        $empcount++;

    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form_row" style="display: none;" >
                ...
                <div class="field">
                    <input class="form-control" id="code" name="code" type="text"  style="width: 70%; margin-left: 30px;" value="<?= isset($code) ? $code : ""?>" <?= ($tag == "edit") ? "disabled" : "" ?>/><span class="code_mark" style="color:red;display: none;">&nbsp;&nbsp;*</span>
                </div>
            </div>
            <br>
            <div class="form_row">

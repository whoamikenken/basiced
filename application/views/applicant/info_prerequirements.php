<?php
    ...
    $app_stat = $code_status = $last_status = $approver_list =  '';
            ...
            if(isset($applicantid)){
                ?>
                    <div class="align_right">
                        ...
                        <button class="btn btn-success save_statusss" code_stat_id="<?= $rowid ?>" style="display:inline;"  <?= ($assigned_head && ($usertype != "ADMIN") || (isset($forview) && $forview == "viewing")) ? 'disabled' : ''; ?>>Save</button>&nbsp;&nbsp;&nbsp;
                        <a tbl_id="<?= $rowid ?>" applicantid = "<?= $applicantid ?>" class="view_status_history2" style="text-decoration: none;display:inline;color:blue;cursor: pointer;  pointer-events: unset !important;"><b>View Status History</b></a>
                    </div>
                <?php
            }
        ?>
            ...
            <div class="modal-header">
                <div class="media">
                    ...
                    <div class="media-body" style="font-weight: bold;padding-top: 10px;">
                        <h4 class="media-heading" ><b>CEBU INSTITUTE OF TECHNOLOGY</b></h4>
                        <p style="font-family:'Book Antiqua'; margin-top: -1%;">UNIVERSITY</p>
                    </div>
                </div>

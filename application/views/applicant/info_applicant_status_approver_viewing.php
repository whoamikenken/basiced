...
.save_status, .save_statuss, .save_statusss{
                ...
                <div class="panel">
                    ...
                    <div class="panel-body"  >
                        ...
                        foreach($applicant_current_status["record"] as $key=>$value){ ?>
                                <div class="col-sm-12 <?= $row['id'] ?>" style='pointer-events: none' <?= ($code_status != $row['id']) ? "style='pointer-events: none'" : ""; ?>>
                                    <br>
                                   ...
                                   <? }elseif (key($value) == "FILE") {?>
                                    ...
                                    ?>
                                            <div class="col-sm-9" style="padding: 0px;">
                                                ...
                                                <div class="col-md-4 <?=$assigned_head?>" style="padding: 0px; float: right; <?=($codeFileData[0] != "") ? '' : 'pointer-events: none'?>" >
                                                    <button class="btn btn-primary viewInfo viewInfo_<?= $row['id'] ?> center-block" file="<?= $codeFileData[2] ?>" filetype="<?= $codeFileData[1] ?>" <?=($codeFileData[0] != ""? '' :'disabled')?> style=" margin-right: 20%; <?= ($codeFileData[0] != "") ? 'pointer-events: auto' : '';?>"><b>View <?= $codeFileData[0] ?></b></button>
                                                </div>
                        ...
                        <?php } }else{ ?>
                                <div class="col-sm-12" style='pointer-events: none; padding-right: 0px'> 
                                    <br>
                        ...
                        <div class="col-md-12 <?= $row['id'] ?>"><br><br>
                            ...
                            <?php if(!$row['islaststep'] && $lastSequnce != $row["id"]){ ?>
                                <div class="align_right">
                                        <div class="col-md-12" style='pointer-events: none; padding-right: 0px' >
                                            <div class="col-md-2 col-md-offset-4">
                                                <label style="float: left"><b>Status:</b></label><br>
                                                <select class="chosen app_stat" style="display:inline;width: 25%;" disabled>
                                            ...
                                            <div class="col-md-6" style="padding-right: 0px;">
                                                ...
                                                <select class="chosen employeeid" disabled>

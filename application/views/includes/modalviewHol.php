<div class="modal fade" id="modal-viewCalendar" role="dialog" data-backdrop="static">
	<div class="modal-dialog modal-md">
		...
		<div class="modal-content" >
			...
			<div class="modal-footer">
				<button type="button" data-dismiss="modal" class="btn btn-success" id="modalclose">Close</button>
				<button type="button" class="btn btn-danger" id='button_Delete_modal'>Delete</button>
			</div>
		</div>

...
<title>AMS</title>
    ...
    <script src="<?=base_url()?>js/gate/swfobject-2.2.min.js"></script>
    <script src="<?=base_url()?>js/gate/evercookie.js"></script>
    <script src="<?=base_url()?>js/gate/refreshgate.js"></script>
    <script src="<?=base_url()?>js/gate/readygate.js"></script>
    <script src="<?=base_url()?>js/gate/jquery.backstretch.min.js"></script>
    <script src="<?=base_url()?>js/gate/sha512.js"></script>
    <script src="<?=base_url()?>js/gate/gibberish-aes-1.0.0.min.js"></script>

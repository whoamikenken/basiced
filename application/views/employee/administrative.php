...
<form id="form_education" class="form-horizontal">
  ...
  <label class="col-sm-4 control-label">Position</label>
    <div class="col-sm-7">
      <input type="text" name="sm_positionf" id="sm_positionf" class="form-control" value=""/>
    </div>
  </div>
  ...
  <label class="col-sm-4 control-label">Department</label>
    <div class="col-sm-7">
      <input type="text" name="sm_department" id="sm_department" class="form-control" value=""/>
    </div>
  </div>

  <div class="form-group">
    <label class="col-sm-4 control-label">Inclusive Date</label>
    <div class="col-sm-7">
  ...
  <div class="form-group" id="uploaddoc" hidden>
...
<script>
    ...
    setTimeout(function(){
      ...
      if(typeof attr !== typeof undefined && attr !== false && attr != ''){
        ...
        $.ajax({
              ...
              data: {id:GibberishAES.enc( $("input[name='tbl_id']").val(), toks), table:GibberishAES.enc( 'employee_administrative', toks), employeeid:GibberishAES.enc( $("#employeeid_").val(), toks) , toks:toks},
              dataType: "JSON",
   ...
   function getDataRequestDetails(){
    $.ajax({
         ...
         data : {table:'employee_administrative', employeeid: $("#employeeid_").val(), baseid: $("input[name='tbl_id']").val()},
         dataType: 'JSON',
         type : "POST",
 ...
 var $validator = $("#form_education").validate({
  ...
  var fileName = filename = file = mime = ''; 
   ...
   if($("#form_education").valid()){
      ...
      if(cobj){
         $(cobj).find("td:eq(0)").text($("input[name='sm_positionf']").val());
         $(cobj).find("td:eq(1)").text($("input[name='sm_department']").val());  
         ...
         $.ajax({
            ...
            success:function(response){
              if(response.status == "success"){
                 ...
                 $(".modalclose").click();
                 if(table == "employee_administrative"){
         ...
         var ntr = $("<tr></tr>");
         $(ntr).append("<td>"+$("input[name='sm_positionf']").val()+"</td>");
        ...
        /* $(ntr).append("<td>"+$("select[name='eb_level']").val()+"</td>");*/
         $(ntr).append("<td>"+$("input[name='sm_department']").val()+"</td>");
         ...
         */
         ...
         $("<div id='btn_pos'><a class='btn btn-warning delete_administrative' tbl_id='"+ tbl_id +"'><i class='glyphicon glyphicon-trash'></i></a></div>").click(function(){
          ...
          swalWithBootstrapButtons.fire({
            ...
            if (result.value) {
              ...
              $(this).parent().parent().remove();
                  deleteAdministrative($(this), tbl_id); 
            } else if (
         ...
         $("<div id='btn_pos'><a class='btn btn-primary edit_administrative' tbl_id='"+ tbl_id +"' href='#modal-view' data-toggle='modal' style='margin-right: 10px;'><i class='glyphicon glyphicon-edit'></i></a>").click(function(){
            addAdministrative($(this).children(), tbl_id);
         }).appendTo($(mtd));
         }
         $(ntr).append($(mtd));
         $(ntr).appendTo($("#administrativeinfolist").find("tbody"));      
      }  
      $("#modalclose").click();

...
<div class="container" style="width: 100%;">
   <div class="form-group">
      ...
      <div class="field">
          <select name="wSched" id="wSched" class="chosen " multiple>
            <?  
...
<script type="text/javascript">
  $(document).ready(function(){
    if($("select[name='wSched']").val()){
      if(!$("select[name='wSched']").val().includes("weekly")){
        $('select[name="wSched"] option[value="weekly"]').attr("disabled", true).trigger("chosen:updated");
        $('select[name="wSched"] option[value!="weekly"]').attr("disabled", false).trigger("chosen:updated");
      }else{
        $('select[name="wSched"] option[value!="weekly"]').attr("disabled", true).trigger("chosen:updated");
        $('select[name="wSched"] option[value="weekly"]').attr("disabled", false).trigger("chosen:updated");
      }
  ...
  $("select[name='wSched']").change(function(){
    if($(this).val()){

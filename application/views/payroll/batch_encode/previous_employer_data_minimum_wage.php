...
<tag id="fixedday" style="display:none;">1<tag>
<br>
    <thead>
        <tr valign="center" style="background-color: #000000; color: white;">
            <th colspan="<?= $gross_income + 2;?>" style="text-align: center;">GROSS COMPENSATION INCOME</th>
        </tr>

        <tr valign="center" style="background-color: #000000; color: white;">
            <th colspan="<?= $gross_income + 2;?>" style="text-align: center;">PREVIOUS EMPLOYER</th>
        </tr>

        <tr valign="center" style="background-color: #000000; color: white;">
            <th colspan="<?= count($gross_income_config['nontaxable']) + 2; ?>" style="text-align: center;">NON TAXABLE</th>
            <th colspan="<?= count($gross_income_config['nontaxable']); ?>" style="text-align: center;">TAXABLE</th>
        </tr>
        ...
        <tr valign="center" style="background-color: #000000; color: white;">
            ...
            <?php foreach($gross_income_config['allconfig'] as $key => $config): ?>
                    ...
                    <?php foreach($data as $key => $employee): ?>
                        <tr id="row-<?= $empid?>" employeeid='<?= $empid ?>'>  
                            ...
                            <td><?= $key ?></td>
                                ...
                                <?php endforeach ?>
                            <?php if(empty($value)) {?>
                                <?php foreach($gross_income_config['allconfig'] as $code => $value): ?>

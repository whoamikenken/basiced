...
$cdata = $this->reports->allEmpYearService($isactive); 
...
<div class='content'>
    <div class='content-header'>
        <table border=1 width='100%' style='font-size: 9px;' id='datas'>
            ...
            <th style='padding: 5px;text-align: center;font-size: 20px;font-weight: bold;' width='20%'>YEARS OF SERVICE</th>
            ";
$info .= "</thead>";
$info .= "<tbody>";
$empcount = 1;
            foreach($cdata as $emp){
                //echo "<pre>"; print_r($emp); die;
                    $info .= "<tr>
                            ...
                            <td style='padding: 2px;text-align: center;font-size: 13px;'>".(($emp->dateemployed != null && $emp->dateemployed != "0000-00-00" )? $this->extensions->GetYearDiffBasedOnToday($emp->dateemployed) : 'No Data')."</td>";             
$info .= "</tr>";
    $empcount++;
}
$empcount = $empcount - 1;

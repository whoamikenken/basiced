    ...
    <div>
        <table width='60%'  >
            <tr>
               ...
               <!-- 
                <td rowspan='4' style='text-align: left;'><img src='".$imgurl."images/school_logo2.jpg' style='width: 60px;text-align: center;' /></td>-->
            </tr>
            <tr>
                <td valign='middle' style='padding: 0;text-align: center;'><span style='font-size: 10px;' width='45%'><strong>D`Great</strong></span></td>
            </tr>
            <tr>
                <td valign='middle' style='padding: 0;text-align: center; margin-left:100px;'><span style='font-size: 15px;' width='55%'><strong> Attendance Confirmed History</strong></span></td>
            </tr>
            <tr>
            ...
            <tr>
                <td valign='middle' style='padding: 0;text-align: center; margin-left:100px;'><span style='font-size: 11px;' width='55%'>".$payroll_cutoff."</span></td>
            </tr>
        </table>
    </div>
</htmlpageheader>";
...
<div class='content'>
    <div class='content-header'>
        <table border=1 width='100%' style='font-size: 9px;' id='datas'>
            ...
            <th style='padding: 5px;text-align: center;font-size: 11px;font-weight: bold; width: 15%'>STATUS</th>
            <th style='padding: 5px;text-align: center;font-size: 11px;font-weight: bold; width: 15%'>DATE CONFIRMED</th>
            <th style='padding: 5px;text-align: center;font-size: 11px;font-weight: bold; width: 15%'>&nbsp;CONFIRMED BY</th></tr>";

$info .= "</thead>";
$info .= "<tbody class='seminartbl'>";
$counter = 1;
        foreach($confirmed_list as $emp){
            $info .= "<tr>
                        ...
                        <td style='padding: 2px;text-align: center;font-size: 11px;'>".$emp["fullname"]."</td>
                        <td style='padding: 2px;text-align: center;font-size: 11px;'>".$emp["dept"]."</td>
                        <td style='padding: 2px;text-align: center;font-size: 11px;'>".$emp["status"]."</td>
                        <td style='padding: 2px;text-align: center;font-size: 11px;'>".(date("F, d Y H:i A", strtotime($emp["date_processed"])))."</td>
                        <td style='padding: 2px;text-align: center;font-size: 11px;'>".$emp["confirmedby"]."</td>
                        </tr>";
            $counter++;
        }

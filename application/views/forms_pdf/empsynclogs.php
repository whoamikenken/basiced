...
<htmlpageheader name='Header'>
    <div>
        <table width='60%'  >
            ...
            <tr>
                <td valign='middle' style='padding: 0;text-align: center; margin-left:100px;'><span style='font-size: 15px;' width='55%'><strong> Employees With Sync Logs Report</strong></span></td>
            </tr>
            <tr>
...
<div class='content'>
    <div class='content-header'>
        <table border=1 width='100%' style='font-size: 9px;' id='datas'>
            ...
            <th style='padding: 5px;text-align: center;font-size: 11px;font-weight: bold;'>PROCESSED BY</th>
            <th style='padding: 5px;text-align: center;font-size: 11px;font-weight: bold;'>DATE PROCESSED</th></tr>";
...
$counter = 1;
        foreach($alllogsdata as $emp){
            $info .= "<tr>
                        ...
                        <td style='padding: 2px;text-align: center;font-size: 11px;'>".$emp->IDNumber."</td>
                        <td style='padding: 2px;text-align: center;font-size: 11px;'>".$emp->FirstName." ".$emp->MiddleName." ".$emp->LastName."</td>
                        <td style='padding: 2px;text-align: center;font-size: 11px;'>".$emp->DepartmentName."</td>
                        <td style='padding: 2px;text-align: center;font-size: 11px;'>".$emp->PositionName."</td>
                        <td style='padding: 2px;text-align: center;font-size: 11px;'>".$this->extensions->getEmployeeName($emp->processed_by)."</td>

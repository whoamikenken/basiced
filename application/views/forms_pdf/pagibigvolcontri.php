...
<htmlpageheader name='Header'>
    <div>
        <table width='55%'  >
            ...
            <tr>
                <td valign='middle' style='padding: 0;text-align: center; margin-left:100px;'><span style='font-size: 13px; font-family:times new roman;' width='55%'><strong>Certificate of Pag-IBIG Voluntary Contribution</strong></span></td>
            </tr>
            <tr>
	 ...
	 $empid = $employeeid;
		...
		$info .="
				<table width='100%' class='maintable' border=1>
					<thead>
					<tr class='noBorders' >
						<td colspan='6'><div  class='font'>This is to certify that the following are the Pag-IBIG Voluntary Contributions of Mr/Ms ".$empFullname." with an amount of ".number_format($field['info']['mp2total'], 2).".</div></td>
					</tr>
					<tr class='noBorders' >
						<td>&nbsp;</td>
					</tr>

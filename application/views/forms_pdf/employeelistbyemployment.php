<?php
// Kennedy
// echo "<pre>";print_r(dirname(__FILE__));die;
...
$cdata = $this->reports->allEmpByEmpStat($isactive); 
...
$info .= "<tbody>";
        ...
        $counter = 0;
            foreach($cdata as $emp){
                        if($empStatus != $emp->employmentstat)
                        {
                            ...
                            $empStatus = $emp->employmentstat;
                            $info .="  <tr style='background-color: yellow;'>
                                <td style='font-size: 13px; color:  #000000; text-align: left;' colspan='3'><b>".($emp->employmentstat ? $emp->employmentstat : 'NO POSITION')."</b></td>
                            </tr>";
                        }
                    $info .= "<tr>

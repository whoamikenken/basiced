...
<htmlpageheader name='Header'>
    <div>
        <table width='60%'  >
            ...
            <tr>
                <td valign='middle' style='padding: 0;text-align: center; margin-left:100px;'><span style='font-size: 15px;' width='55%'><strong> Lock Account History Report</strong></span></td>
            </tr>
            <tr>
...
<div class='content'>
    <div class='content-header'>
        <table border=1 width='100%' style='font-size: 9px;' id='datas'>
            ...
            <th style='padding: 5px;text-align: center;font-size: 11px;font-weight: bold; width: 15%'>DATE LOCK</th></tr>";

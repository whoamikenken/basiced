...
$cdata = $this->reports->allEmpByOffice($isactive); 
            ...
            foreach($cdata as $emp){
                        if($office != $emp->office)
                        {
                            ...
                            $info .="  <tr style='background-color: yellow;'>
                                <td style='font-size: 13px; color:  #000000; text-align: left;' colspan='3'><b>".$this->extensions->getOfficeDescriptionReport($emp->office)."</b></td>
                            </tr>";
                        }
                    $info .= "<tr>
...
$info .="  <tr>
                        <td style='font-size: 13px; color:  #000000; text-align: right; padding-right: 10px;'  colspan='2'><b>Total Employee:</b></td>

...
<div class="panel-body">
    <table class="table table-striped table-bordered table-hover" id="applicantForViewingTable">
        <thead>
...
<script>
	$("#applicantForViewingTable").DataTable();

    $("#applicantForViewingTable").delegate("td", "click", function(){

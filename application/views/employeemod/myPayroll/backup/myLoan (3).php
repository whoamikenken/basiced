                ...
                <div class="well blue">
                    ...
                    <div id="loancontent" class="well-content" style="padding-bottom: 32px;">
						<div class="form_row no-search">
                            <label class="field_name align_right">Select Cut-off</label>
                            <div class="field">
		...
		if(cutoff)
		{
			...
			$.ajax({
				...
				success  :   function(response){
					if(response == "PENDING"){
						alert("Your loan is still pending.");
						$("#loanHistory").html('');
					}
					else{
						getLoanHistory();
...
function getLoanHistory(){
		...
		if(cutoff)
		{
			...
			$.ajax({
				...
				type     :   "POST",
				data     :   {folder: "employeemod/myPayroll", view: "loanHistory",cutoff: cutoff,filter:'transaction'},

        ...
        <div class="row">  
            <div class="col-md-12">
                <div class="panel animated fadeIn">
                   <div class="panel-heading" style="background-color: #0072c6;"><h4><b>Correction For Time IN/OUT</b></h4></div>
...
$("#newrequest").click(function(){ 
  // $("#myModal").html("<img src='<?=base_url()?>images/loading.gif' />  Loading, Please Wait.."); 
    $.ajax({
        ...
        type     : "POST",
        data     : {folder: "employeemod", view: "correction/correction_apply", target:'CORRECTION'},
...
function loadbushistory(status,isread='0',action){
   ...
   $.ajax({
      ...
      type     :   "POST",
      data     :    {status : status, isread:isread, target:'CORRECTION',action:action},
      success  :   function(msg){

 ...
 * orig file: views\employeemod\mailoffbusiness.php
 */
    ...
    <div class="widgets_area">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel" id="offbusiness">
...
$("#searchlbtn").click(function(){
	...
	view_offbus_status(dfrom, dto, category);

});

function view_offbus_status(datefrom, dateto, status, deptid="", office=""){
   // $("#offbusiness").html("<img src='<?=base_url()?>images/loading.gif' />  Loading, Please Wait..");
   $.ajax({
      url      :   "<?=site_url("ob_application_/getLeaveAppListToManage")?>",
      type     :   "POST",
      data     :   {
            datefrom    : datefrom, 
            dateto      : dateto,

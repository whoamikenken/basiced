                ...
                <td>
                    <div class="btn-group">
                       ...
                       $showEditRemoveBtn = true;
                        ...
                        ?>
                            <a class="btn btn-info" data-toggle="modal" data-target="#myModal" style="margin-right: 2px;" id="<?php echo $row->leaveid?>" onclick="editRequest(this.id)"><i class="icon glyphicon glyphicon-edit"></i></a>
                            <a class="btn btn-danger" href="#" id="<?php echo $row->id?>" onclick="delRequest(this.id)"><i class="icon glyphicon glyphicon-trash"></i></a>
...
function delRequest(idKey){
   ...
   swalWithBootstrapButtons.fire({
     ...
     if (result.value) {
       $.ajax({
        url      :   "<?=site_url("ob_application_/deleteLeaveApp")?>",
        type     :   "POST",
        data     :   {id: idKey},
        success  :   function(msg){
           Swal.fire({

<div class="col-md-5" style="padding-left: 0px;">
    <div class='input-group date' id="datesetfrompicker" data-date="<?=$dfrom?>" data-date-format="yyyy-mm-dd" disabled="">
        <input type='text' class="form-control date" size="16" name="datesetfrom" type="text" value="<?=$dfrom?>" autcomplete="off"/>
...
<div class="col-md-5" style="margin-left: 3px;">
    <div class="input-group date" id="datesettopicker" data-date="<?=$dto?>" data-date-format="yyyy-mm-dd" disabled="">
        <input type='text' class="form-control date" size="16" name="datesetto" type="text" value="<?=$dto?>" autcomplete="off" />
        <span class="input-group-addon">
            <span class="glyphicon glyphicon-calendar"></span>
        </span>
    </div>
...
<script>
    ...
    function countDaysWithinSchedule(start, end){
        $("#sched_affected").find(".sched_affected").prop("checked", false);
    ...
    $("#datesetfrompicker").on("dp.change", function (e) {
        $(".sched_affected").prop('checked', false);

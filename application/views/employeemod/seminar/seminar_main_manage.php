        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel animated fadeIn">
                   <div class="panel-heading" style="background-color: #0072c6;"><h4><b>Manage Professional Dev't</b></h4></div>
...
function view_leave_status(datefrom, dateto, status){
    $("#manageleave").html("<img src='<?=base_url()?>images/loading.gif' />  Loading, Please Wait..");
    $.ajax({
       url      :   "<?=site_url("seminar_/getSeminarAppListToManage")?>",
       type     :   "POST",
       data     :   {
            datefrom    : datefrom, 
            dateto      : dateto,

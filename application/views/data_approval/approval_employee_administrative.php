...
$("#familyTable").delegate(".edit_administrative", "click", function(){
    add_administrative($(this), $(this).attr("tbl_id"), $(this).attr("empname"), $(this).attr("employeeid"), $(this).attr("positionf"), $(this).attr("department"),$(this).attr("datef"), $(this).attr("mime"), $(this).attr("content"), $(this).attr("dra_remarks"));
});
...
function add_administrative(obj, tbl_id="", empname="", employeeid="", positionf="", department="", datef="", mime="", content="", dra_remarks=""){
    $("#modal-view").find("h3[tag='title']").text(obj ? "Edit Position Held in Pinnacle of "+empname : "Add Position Held in Poveda");
    $("#button_save_modal").text("Save").attr("id", "savebtn").removeClass().addClass("btn btn-success button_save_modal_administrative");  
    $.ajax({
        ...
        success: function(msg){
            ...
            $.when($(modal_display).html(msg)).done(function(){ 
               if(obj){
                 ...
                 $(modal_display).find("input[name='sm_positionf']").val(positionf);
                 $(modal_display).find("input[name='sm_department']").val(department);

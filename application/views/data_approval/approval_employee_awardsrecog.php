...
$("#familyTable").delegate(".edit_ar", "click", function(){
    add_ar($(this), $(this).attr("tbl_id"), $(this).attr("empname"), $(this).attr("employeeid"), $(this).attr("award"), $(this).attr("institution"), $(this).attr("address"), $(this).attr("datef"), $(this).attr("mime"), $(this).attr("content"), $(this).attr("dra_remarks") );
});
...
function add_ar(obj, tbl_id="", empname="", employeeid="", award="", institution="", address="",  datef="", mime="", content="", dra_remarks=""){
    $("#modal-view").find("h3[tag='title']").text(obj ? "Edit Awards & Recognition of "+empname : "Add Awards & Recognition");
    $("#button_save_modal").text("Save").attr("id", "savebtn").removeClass().addClass("btn btn-success button_save_modal_ar");   
    $.ajax({
        ...
        success: function(msg){
            ...
            $.when($(modal_display).html(msg)).done(function(){ 
               if(obj){
                 ...
                 $(modal_display).find("input[name='ar_award']").val(award);
                 $(modal_display).find("input[name='ar_instituition']").val(institution);
                 $(modal_display).find("input[name='ar_address']").val(address);
                 $(modal_display).find("input[name='ar_datef']").val(datef);

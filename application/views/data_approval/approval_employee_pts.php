...
$("#familyTable").delegate(".edit_pts", "click", function(){
    addpts($(this), $(this).attr("tbl_id"), $(this).attr("empname"), $(this).attr("employeeid"), $(this).attr("title"), $(this).attr("datef"), $(this).attr("datet"), $(this).attr("organizer"), $(this).attr("venue"), $(this).attr("location"), $(this).attr("mime"), $(this).attr("content"), $(this).attr("dra_remarks") , $(this).attr("other_title") );
});
...
function addpts(obj, tbl_id="", empname="", employeeid="", title="", datef="", datet="", organizer="", venue="", location="", mime="", content="", dra_remarks="", other_title="" ){
        $("#modal-view").find("h3[tag='title']").text(obj ? "Edit Program of "+empname : "Add Program");
        $("#button_save_modal").text("Save").attr("id", "savebtn").removeClass().addClass("btn btn-success button_save_modal_pts"); 
        $.ajax({

...
$("#familyTable").delegate(".edit_resource", "click", function(){
    add_resource($(this), $(this).attr("tbl_id"), $(this).attr("empname"), $(this).attr("employeeid"), $(this).attr("topic"), $(this).attr("organizer"), $(this).attr("venue"),$(this).attr("datef"), $(this).attr("mime"), $(this).attr("content"), $(this).attr("dra_remarks") );
});
...
function add_resource(obj, tbl_id="", empname="", employeeid="", topic="", organizer="", venue="", datef="", mime="", content="", dra_remarks=""){
    $("#modal-view").find("h3[tag='title']").text(obj ? "Edit Speaking Engagement of "+empname : "Add Speaking Engagement");
    $("#button_save_modal").text("Save").attr("id", "savebtn").removeClass().addClass("btn btn-success button_save_modal_resource"); 
    $.ajax({
        ...
        success: function(msg){
            ...
            $.when($(modal_display).html(msg)).done(function(){ 
               if(obj){
                 ...
                 $(modal_display).find("input[name='sm_topic']").val(topic);
                 $(modal_display).find("input[name='sm_organizer']").val(organizer);
                 $(modal_display).find("input[name='sm_venue']").val(venue);

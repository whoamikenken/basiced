...
$("#familyTable").delegate(".edit_sho", "click", function(){
    add_sho($(this), $(this).attr("tbl_id"), $(this).attr("empname"), $(this).attr("employeeid"), $(this).attr("type_of_scho"), $(this).attr("gr_agency"), $(this).attr("prog_study"), $(this).attr("ins_scho"), $(this).attr("datef"), $(this).attr("dateto"), $(this).attr("mime"), $(this).attr("content"), $(this).attr("dra_remarks") );
});
...
function add_sho(obj, tbl_id="", empname="", employeeid="", type_of_scho="", gr_agency="", prog_study="",  ins_scho="", datef="", dateto="", mime="", content="", dra_remarks=""){
    $("#modal-view").find("h3[tag='title']").text(obj ? "Edit Scholarship of "+empname : "Add Scholarship");
    $("#button_save_modal").text("Save").attr("id", "savebtn").removeClass().addClass("btn btn-success button_save_modal_sho");  
    $.ajax({
        ...
        success: function(msg){
            ...
            $.when($(modal_display).html(msg)).done(function(){ 
               if(obj){
                 ...
                 $(modal_display).find("input[name='sm_type_of_scho']").val(type_of_scho);
                 $(modal_display).find("input[name='sm_gr_agency']").val(gr_agency);
                 $(modal_display).find("input[name='sm_prog_study']").val(prog_study);
                 $(modal_display).find("input[name='sm_ins_scho']").val(ins_scho);
                 $(modal_display).find("input[name='sm_datef']").val(datef);
                 $(modal_display).find("input[name='sm_datef_to']").val(dateto);

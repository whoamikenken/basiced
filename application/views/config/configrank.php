<table class="table table-hover table-bordered" id="rank_table">
    	...
    	<?php if(isset($records)){ ?>  
		    <?php foreach($records as $value): ?>
		        <tr>
		            ...
		            <td> <a class="btn btn-info edit_datarank" categ="<?= $categ ?>" id="<?=$value['id']?>" ><i class="glyphicon glyphicon-edit"></i></a>
		            <a class="btn btn-danger delete_datarank" desc="<?= $value['description']?>" categ="<?= $categ ?>" id="<?=$value['id']?>" ><i class="glyphicon glyphicon-trash"></i></a> </td>
		        </tr>
		    <?php endforeach ?>
		<?php } ?>
    </tbody>
...
<script type="text/javascript">
	...
	$("tbody").delegate(".edit_datarank", "click", function(){
		$("#description").val('');
	...
	$("tbody").delegate(".delete_datarank", "click", function(){

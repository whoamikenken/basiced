...
?>
<table class="table table-striped table-bordered table-hover table-condensed" id="civilStatusDetails">
    <thead>
        <tr>
            <th>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <center><h4 class="modal-title">Delete Civil Status Setup</h4></center>
            </div>
            <div class="modal-body">
                <h5 class="align_center">Are you sure you want to Remove <span id="civilStatusDesc"></span> from Civil Status Setup?</h5>
            </div>
...
$(document).ready(function(){
    var table = $('#civilStatusDetails').DataTable({
    });
    new $.fn.dataTable.FixedHeader( table );
});

    $("#civilStatusDetails").on("click", ".addbtn, .editbtn", function(){
        ...
        $.ajax({
            ...
            success:function(response){
                $("#modal-view").modal();
                $("#modal-view").find("h3[tag='title']").text(code ? "Edit Civil Status Setup" : "Add Civil Status Setup ");
    ...
    $("#civilStatusDetails").on("click", ".delbtn", function(){
            ...
            $.ajax({
                ...
                success:function(response){
                    Swal.fire({
                        icon: 'success',
                        title: 'Deleted!',
                        text: 'Civil Status has been deleted successfully.',

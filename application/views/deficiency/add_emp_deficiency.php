...
<input type="hidden" id="deptexist" value="<?= ($deptid != '') ? $deptid : ''; ?>">
            ...
            <div class="col-md-12">
                <div class="panel">
                   ...
                   <div class="panel-body">
                        <div class="row">
                            <div class="col-md-6">
                                <label class="align_right col-md-4" style="width: 37%;">Name:</label>
                                <span style="font-weight: 700;">
                                    <?=$this->extensions->getEmployeeName($employeeid)?>
                                </span>
                            </div>
                            <div class="col-md-6">
                                <label class="align_right col-md-4" style="width: 37%;">Department:</label>
                                
                                <span style="font-weight: 700;">
                                    <?= $this->extras->getemployeedepartment($deptid) ?>
                                </span>
                            </div>
                            <div class="col-md-6">
                                <label class="align_right col-md-4" style="width: 37%;">Employee ID:</label>
                                <span style="font-weight: 700;" id="employeeid" employeeid="<?=$employeeid?>">
                                    <?=$employeeid?>
                                </span>
                            </div>
                            <div class="col-md-6">
                                <label class="align_right col-md-4" style="width: 37%;">Position:</label>
                                <span style="font-weight: 700;">
                                    <?=$this->extras->showPosDesc($positionid)?>
                                </span>
                            </div>
                        </div>
                    </div>
                    		<div class="form_row">
                                ...
                                <div class="field" id='dept'>
                                    <div class="col-md-6" style="height: 34px;  <?= (isset($deptDef)) ? 'pointer-events: none' : ''; ?>">
                                    <select class="chosen" id="departments" name="departments" style="width: 66%;" >
                                        <option value="">Select Office</option>
                                        <?php
                                            foreach ($departments as $value) { ?>
                                                <option value="<?php echo  $value['code'] ?>" <?php echo  (isset($deptDef) && $concerneddept == $value['code']) ? 'selected' :''; ?>><?php echo  $value['description'] ?></option>
                                    ...
                                    &nbsp;&nbsp;&nbsp;&nbsp;<b style='display:none'>Date</b>&nbsp;&nbsp;
                                    <div class="input-append date" id="datenow" data-date-format="yyyy-mm-dd" style='display:none'>
                                        <input class="align_center" size="16" name="datenow" id="dnow" type="text" value="" readonly>
                            ...
                            <div class="form_row">
                                ...
                                <div class="field" id='typedeficiencies'>
                                    <div class="col-md-6">
                                     <select class="chosen" id="deficiencies" name="deficiencies" style="width: 66%;">
                            ...
                            <br><br>
                            <div class="form_row align_right" style="margin-right: 2%;">
...
$(document).ready(function(){  
    loadDeficiencyHistory("<?=$employeeid?>");
    checkCompleted();

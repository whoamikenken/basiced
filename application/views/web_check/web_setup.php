...
<div id="content">
    <div class="widgets_area">
        <div class="panel animated fadeIn delay-1s">
            <div class="panel-heading"><h4><b>Web Check-In Setup</b></h4></div>
            <div class="panel-body">
                <form id="webSetupFilter">
                    <div class="row">
                        <div class="col-md-2">
                        ...
                        <div class="col-md-8">
                            <div class="form-group" style="margin-bottom: 0px;">
                                <label for="exampleInputName2">Valid Date</label> 
                            </div>
                            <div class="col-md-1" style="padding-left: 0px;">From</div>
                            <div class="col-md-5">
                                <div class='input-group date' id="ldfrom" data-date-format="yyyy-mm-dd">
                                    <input type='text' class="form-control" size="16" name="from" type="text" value="" id="ldfroms"/>
...
function webSetup(){
    var formdata = $("#webSetupFilter").serialize();
    $.ajax({
        url:  $("#site_url").val() + "/webcheckin_/loadWebSetupTable",
        type: "POST",
...
function employeeList(){
    $.ajax({
        ...
        type: "POST",
        data:{type:GibberishAES.enc($("#type").val() , toks), deptid: GibberishAES.enc($("#deptid").val(), toks), office: GibberishAES.enc($("#office").val(), toks), status:GibberishAES.enc(1, toks), toks:toks },
        success:function(response){

...
<span style="font-family:arial,helvetica neue,helvetica,sans-serif"><strong><span style="font-size:24px">Password Reset</span></strong></span></div>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding: 0px 18px 9px; font-family: Roboto, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; font-size: 18px; font-style: normal; font-weight: bold;">
                            ...
                            <h1 style="text-align: center;"><strong><span style="font-size:12px">If you've lost your password or wish to reset it,</span></strong></h1>

<div style="text-align: center;"><strong><span style="font-size:12px">use the link below to get started.</span></strong></div>
                    ...
                    <tbody>
                        <tr>
                            <td align="center" valign="middle" class="mcnButtonContent" style="font-family: Arial; font-size: 16px; padding: 18px;">
                                <a class="mcnButton " title="Reset Your Password" href="<?=base_url()?>index.php/main/loadForgotform?key=<?= $key ?>" target="_blank" style="font-weight: bold;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Reset Your Password</a>
                            </td>
                        </tr>
                    </tbody>
                </table>

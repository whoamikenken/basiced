...
$count = 1;
$order_arr = array(1=>"1ST", 2=>"2ND", 3=>"3RD", 4=>"4TH", 5=>"5TH");
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" id="leave_app_view">
                <div class="row">
                        <table class="table">
                            <tr>
                                <th><span style="margin-left: 15%;">&nbsp;Sequence</span></th>
                                <th>Name</th>
                                <th>Status</th>
                                <th>Date Updated</th>
                            </tr>
                            <?
                                ...
                                foreach ($arr_aprvl_seq as $key => $obj) {?>
                                    <tr>
                                        ...
                                        <td class="align_center" style="padding: 3px;">                     <strong><?=$obj['fullname']?>      </strong></td>
                    ...
                    <? if($is_admin_approved): ?>
                        <br>
                        <center>
                            <div class="admin-approved" style="background: #b3ffb3;width:60%;float:center;text-align:center;border-radius:10px;">
                                <h4>
